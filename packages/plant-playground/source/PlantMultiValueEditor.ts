...
export class PlantMultiValueEditor extends LitElement {
  ...
  @state()
  private _nextValue: string | undefined;
  ...
  @query("#input")
  private _input: SlInput | null | undefined;
  @query("#dropdown")
  private _dropdown: SlDropdown | null | undefined;

  private _addNextValue() {
    if (!Array.isArray(this.value) || !this._nextValue) {
      return;
    }
